...
const projects: Project[] = [
  ...
  },
  {
    ...
    viewUrl: "https://expo.dev/accounts/alms1/projects/wave/builds/f8795ec9-ff9c-44ac-8224-d139e161377c",
  },
];
      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20 md:py-24">
        <header className="max-w-2xl">
          ...
          <p className="mt-5 text-base leading-[1.75] text-muted-foreground sm:text-[1.0625rem]">
            Selected mobile applications from my portfolio. Click “View” to explore each project in more detail.
          </p>
        </header>
